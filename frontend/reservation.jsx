<>
  {"{"}% extends "base.html" %{"}"}
  {"{"}% load static %{"}"}
  {"{"}% block title %{"}"}Бронювання місць{"{"}% endblock %{"}"}
  {"{"}% block content %{"}"}
  <div className="cinema-page">
    <div className="movie-info">
      <img src="{% static 'images/elio.png' %}" alt="Еліо" />
